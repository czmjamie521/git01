...
public class CommentServlet extends HttpServlet {
	...
	private void commentSubmit(HttpServletRequest request, HttpServletResponse response) throws IOException {
			...
			String	commentid1=request.getParameter("commentid1");
			User user=(User) request.getSession().getAttribute("user");
			ResultInfo<CourseComment> ResultInfo=CommentService.addComment(comment,commentid,user,courseid,commentid1);
