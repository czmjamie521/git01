...
$(function(){
	...
	$("#selectAll").click(function(){
		...
		if(flag){	//全选
			...
			//删除有效
			$("#cartdelete").prop("disabled",false);
		}else{	//全不选, 设置提交订单按钮失效
			$("#cartsubmit").prop("disabled",true);
			//删除失效
			$("#cartdelete").prop("disabled",true);
		}
	...
	$("#cartsubmit").click(function(){
		...
		// 把数据流转到下一个页面
		location ="order?actionName=addOrder&cartItemIds=" +ids.toString(); 
	})
								...
								<tr>
									...
									<td>
										<a href="" class="item-list" id="${item.cartitemid }picture"> 
											<img src="statics/img/course/${item.course.picture }" alt="">
										</a>
									</td>
									<td>
